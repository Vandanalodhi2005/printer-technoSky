    ...
    return (
      <div className="elite-loading">
         ...
         <style>{`
            ...
            .elite-spinner { width: 40px; height: 40px; border: 2px solid #eee; border-top: 2px solid #B19777; border-radius: 50%; animation: spin 0.8s cubic-bezier(0.16, 1, 0.3, 1) infinite; margin-bottom: 20px; }
            .elite-loading p { font-family: 'Montserrat'; font-weight: 900; font-size: 10px; letter-spacing: 5px; color: #111; }
